...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/09 22:00:44 by tclarita          #+#    #+#              #
#    Updated: 2019/09/09 22:00:47 by tclarita         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_countwords.c ft_int_len.c ft_sqrt.c ft_strrev.c ft_swapstr.c ft_memchr.c

OFILES = ft_memset.o ft_bzero.o ft_memcpy.o ft_memccpy.o ft_memmove.o \
...
ft_putchar_fd.o ft_putstr_fd.o ft_putendl_fd.o ft_putnbr_fd.o ft_lstadd.o \
ft_lstdel.o ft_lstdelone.o ft_lstiter.o ft_lstmap.o ft_lstnew.o \
ft_countwords.o ft_int_len.o ft_sqrt.o ft_strrev.o ft_swapstr.o ft_memchr.o 
